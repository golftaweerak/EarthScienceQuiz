...
/**
 * Initializes footer-specific elements, like the dynamic copyright year.
 * This function is designed to be called after the footer component is loaded.
 */
function initializeFooter() {
    const yearSpan = document.getElementById('copyright-year');
    if (yearSpan && !yearSpan.dataset.initialized) {
        yearSpan.textContent = new Date().getFullYear();
        yearSpan.dataset.initialized = 'true'; // Prevent re-running
    }
}

// Listen for the custom event that signals a component has been loaded.

...
export const subCategoryData = {
  ...
  Astronomy: [
    ...
    "12. พิกัดและการเคลื่อนที่ของวัตถุท้องฟ้าเบื้องต้น (ม.ปลาย)",
    "13. สมบัติของดาวฤกษ์ (ม.ปลาย)",
    "14. กำเนิดของเอกภพ (ม.ปลาย)",
    "15. แรงและการเคลื่อนที่เบื้องต้น กฎของนิวตัน (ม.ต้น และ ม.ปลาย)",
    "16. การเคลื่อนที่เป็นเส้นตรงและเส้นโค้ง (ม.ปลาย)",
    "17. พลังงานและโมเมนตัม (ม.ปลาย)",
    "18. ทฤษฎีคลื่นแม่เหล็กไฟฟ้าเบื้องต้น (ม.ปลาย)"
  ],
};
